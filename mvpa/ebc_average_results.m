...
%
% Loads three .mat files with the name STEM<N>.MAT, where N ranges
% from 1 to 3.  Averages the "acts" field of the results.iterations
% struct across all three data files for each regressor and
% each iteration.  Then these are output for use in the EBC
% Feature_Rater scoring program, with the same mean values for each subject.
%
% SUBJ should be one of the subjects who was used in the analysis.
%
% STEM should be the beginning of the filenames where the results
% from each subject were saved.  (e.g., if you saved them as
% 'results1.mat', 'results2.mat', and 'results3.mat', you should
% enter 'results' as the STEM.)
%
% ======================================================================
%
