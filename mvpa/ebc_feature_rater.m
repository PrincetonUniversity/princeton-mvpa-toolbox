...
%
% [OUT] = EBC_FEATURE_RATER(RESULTS, SUBFILE, ...)
%
% SUBJ is the subject that the results correspond to.  This is so
% that the original selectors can be extracted to pad rest if
% necessary.
%
% RESULTS should be an array of result structures returned by
% CROSS_VALIDATION().  It is assumed that the order of the array
% corresponds to the order of the EBC features.
%
% SUBFILE is a string indicated the filename of the submission text
% created by this script.
%
% INUM is the iteration number of each result to use -- this MUST
% correspond to training on subject 1, movie 1, test on subject 1,
% movie 2!
%
% GROUP (optional, default = 'My') the name of the group to be
% written in the EBC header.
%
% SCALE (optional, default = 1) a scalar that all results will be
% multiplied before being saved.
%
% ======================================================================
%
