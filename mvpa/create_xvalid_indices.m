...
sanity_check_for_runs(runs,actives,args.ignore_jumbled_runs)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = sanity_check_for_runs(runs,actives,ignore_jumbled_runs)
...
if length(find(diff(runs)<0)) & ~ignore_jumbled_runs
