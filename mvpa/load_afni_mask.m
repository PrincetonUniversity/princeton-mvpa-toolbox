...
%
% SUB_BRIK (optional, default = []). By default, you'll get an error
% if you try and load in a brik with multiple sub-briks. If your
% brik has no sub-briks, this will load that Set this to a
% number if your brik file contains multiple sub-briks. Note: this
% indexing starts from *1*, not from zero, so you should feed in
% numbers that are one greater than their corresponding sub-brik
% numbers in afni
%
