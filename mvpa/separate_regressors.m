...
%
% Given a regressors matrix, creates new regressors objects with an
% appropriate name (from 'condnames' property) that consist of the
...
% objects.
%
% REGSNAME should be a nConds x nTimepoints matrix of continuous
% regressors values.
%
% CONDNAMES (optional) is a nConds cell array of
...
for c = 1:nConds
  ...
  % record keeping
  created.function = 'separate_regressors';
...
fprintf('Regressors group ''%s'' created by separate_regressors\n', ...
        [regsname, '_grp']);
