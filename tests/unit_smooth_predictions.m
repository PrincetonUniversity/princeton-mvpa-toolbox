function [errmsgs warnmsgs] = test_smooth_predictions(varargin)

% USAGE :[ERRMSGS WARNMSGS] = TEST_(type)
% 
% This is a script that tests temporal smoothing using the
% prediction function.  It mostly tests the parameter handling of
% the function.
%
% INPUT ARGUMENTS:
%
