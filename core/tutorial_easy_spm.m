function [subj results] = tutorial_easy_spm(varargin)

% Tutorial script to accompany TUTORIAL_EASY.HTM
%
% [SUBJ RESULTS] = TUTORIAL_EASY_SPM(varargin)
%
...
%
% FEXTENSION (default = '.nii'). Switch this to '.img' if
% you want to run this on the ANALYZE IMG/HDR dataset.
%
% License:
%=====================================================================
%
...
for i=1:10
    index=num2str(i);
  raw_filenames{i} = ['haxby8_r' index fextension]; %#ok<AGROW>
end
