...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = sanity_check(cursels)

if ~length(find(cursels==1))
  warning('For some reason, you have no training TRs in this iteration');
end

if ~length(find(cursels==2))
  warning('For some reason, you have no testing TRs in this iteration');
end
