...
% If your classifier is non-deterministic, then you want it to
% initialise differently every time. This resets Matlab's random
% number generator seed to something new each time. In case you
% want to reproduce an analysis exactly, the state used is saved in
% results.header
% Thanks to ELN for the reminder about this
results.header.clock = clock;
rand('state',sum(100*results.header.clock));
results.header.randstate = rand('state');
