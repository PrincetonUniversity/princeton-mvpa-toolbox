...
% user.
%
% In this case, if we were to add the property-value pair {'noblanks', false}
% as extra arguments would override the default value of 'true',
% and args.noblanks would be 'false'.
