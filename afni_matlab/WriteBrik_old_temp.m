function [err, ErrMessage, Info] = WriteBrik_old_temp (M, Info, Opt)
%
...
%   Info : the header info of the written brick
%      
%Key Terms:
%   
%More Info :
%   BrikInfo, BrikLoad, WriteBrikHEAD, HEAD_Rules
%     
%     need a FormHEAD function to create a minimal Info structure for a data vector
%
%     version 1.1 (keep in sync. with WriteBrikHEAD)
